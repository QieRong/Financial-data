...
// 获取数据的函数
const fetchPeriodData = async (stockCode: string): Promise<RevenueData[]> => {
...
const fetchQuarterlyData = async (stockCode: string): Promise<RevenueData[]> => {
    const response = await fetch(
...
const fetchYearlyData = async (stockCode: string): Promise<RevenueData[]> => {
    const response = await fetch(
