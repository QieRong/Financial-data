...
// 获取数据的函数
const fetchPeriodData = (stockCode: string): Promise<ProfitData[]> =>
    fetchReportData<ProfitData>("income", "period", stockCode);

const fetchQuarterlyData = (stockCode: string): Promise<ProfitData[]> =>
    fetchReportData<ProfitData>("income", "quarterly", stockCode);

const fetchYearlyData = (stockCode: string): Promise<ProfitData[]> =>
    fetchReportData<ProfitData>("income", "yearly", stockCode);
