...
// 获取数据的函数
const fetchPeriodData = async (stockCode: string): Promise<ExpensesData[]> => {
...
const fetchQuarterlyData = async (stockCode: string): Promise<ExpensesData[]> => {
    const response = await fetch(
...
const fetchYearlyData = async (stockCode: string): Promise<ExpensesData[]> => {
    const response = await fetch(
