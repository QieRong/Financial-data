...
// 获取数据的函数
const fetchPeriodData = async (stockCode: string): Promise<TotalCostData[]> => {
...
const fetchQuarterlyData = async (stockCode: string): Promise<TotalCostData[]> => {
    const response = await fetch(
...
const fetchYearlyData = async (stockCode: string): Promise<TotalCostData[]> => {
    const response = await fetch(
