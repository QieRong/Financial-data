...
// 获取数据的函数
const fetchPeriodData = (stockCode: string): Promise<InterestBearingData[]> =>
    fetchReportData<InterestBearingData>("balance", "period", stockCode);

const fetchQuarterlyData = (stockCode: string): Promise<InterestBearingData[]> =>
    fetchReportData<InterestBearingData>("balance", "quarterly", stockCode);

const fetchYearlyData = (stockCode: string): Promise<InterestBearingData[]> =>
    fetchReportData<InterestBearingData>("balance", "yearly", stockCode);
