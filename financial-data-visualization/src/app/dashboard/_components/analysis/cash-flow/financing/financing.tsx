...
// 获取数据的函数
const fetchPeriodData = (stockCode: string): Promise<FinancingData[]> =>
    fetchReportData<FinancingData>("cashflow", "period", stockCode);

const fetchQuarterlyData = (stockCode: string): Promise<FinancingData[]> =>
    fetchReportData<FinancingData>("cashflow", "quarterly", stockCode);

const fetchYearlyData = (stockCode: string): Promise<FinancingData[]> =>
    fetchReportData<FinancingData>("cashflow", "yearly", stockCode);
